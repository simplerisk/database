...
CREATE TABLE IF NOT EXISTS `CVSS_scoring` (
  ...
  `abrv_metric_name` varchar(3) CHARACTER SET latin1 NOT NULL,
  `metric_value` varchar(30) CHARACTER SET latin1 NOT NULL,
  `abrv_metric_value` varchar(3) CHARACTER SET latin1 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mitigations` (
  ...
  `current_solution` text CHARACTER SET latin1 NOT NULL,
  `security_requirements` text CHARACTER SET latin1 NOT NULL,
  `security_recommendations` text CHARACTER SET latin1 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `risks` (
  ...
  `reference_id` varchar(20) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `regulation` int(11) DEFAULT NULL,
  `control_number` varchar(20) CHARACTER SET latin1 DEFAULT NULL,
  ...
  `assessment` longtext CHARACTER SET latin1 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `risk_scoring` (
  ...
  `CVSS_AccessVector` varchar(3) CHARACTER SET latin1 NOT NULL DEFAULT 'N',
  `CVSS_AccessComplexity` varchar(3) CHARACTER SET latin1 NOT NULL DEFAULT 'L',
  `CVSS_Authentication` varchar(3) CHARACTER SET latin1 NOT NULL DEFAULT 'N',
  `CVSS_ConfImpact` varchar(3) CHARACTER SET latin1 NOT NULL DEFAULT 'C',
  `CVSS_IntegImpact` varchar(3) CHARACTER SET latin1 NOT NULL DEFAULT 'C',
  `CVSS_AvailImpact` varchar(3) CHARACTER SET latin1 NOT NULL DEFAULT 'C',
  `CVSS_Exploitability` varchar(3) CHARACTER SET latin1 NOT NULL DEFAULT 'ND',
  `CVSS_RemediationLevel` varchar(3) CHARACTER SET latin1 NOT NULL DEFAULT 'ND',
  `CVSS_ReportConfidence` varchar(3) CHARACTER SET latin1 NOT NULL DEFAULT 'ND',
  `CVSS_CollateralDamagePotential` varchar(3) CHARACTER SET latin1 NOT NULL DEFAULT 'ND',
  `CVSS_TargetDistribution` varchar(3) CHARACTER SET latin1 NOT NULL DEFAULT 'ND',
  `CVSS_ConfidentialityRequirement` varchar(3) CHARACTER SET latin1 NOT NULL DEFAULT 'ND',
  `CVSS_IntegrityRequirement` varchar(3) CHARACTER SET latin1 NOT NULL DEFAULT 'ND',
  `CVSS_AvailabilityRequirement` varchar(3) CHARACTER SET latin1 NOT NULL DEFAULT 'ND',
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `type` varchar(20) CHARACTER SET latin1 NOT NULL DEFAULT 'simplerisk',
  `username` varchar(20) CHARACTER SET latin1 NOT NULL,
  `name` varchar(50) CHARACTER SET latin1 NOT NULL,
  ...
  `teams` varchar(200) CHARACTER SET latin1 NOT NULL DEFAULT 'none',
