...
INSERT INTO `user` (`value`, `enabled`, `type`, `username`, `name`, `email`, `password`, `last_login`, `teams`, `admin`, `review_high`, `review_medium`, `review_low`, `submit_risks`, `modify_risks`, `plan_mitigations`, `close_risks`, `multi_factor`) VALUES
(1, 1, 'simplerisk', 'admin', 'Admin', 'user@example.com', '$2a$15$21232f297a57a5a743894Oi8eYwNRFyfL7SWQ8schB43FnU2qULWq', '2013-11-17 16:14:44', 'all', 1, 1, 1, 1, 1, 1, 1, 1, 1);